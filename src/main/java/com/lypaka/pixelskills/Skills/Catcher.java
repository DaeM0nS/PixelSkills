...
public class Catcher {
    ...
    * */
    ...
    private boolean isLegendary(EntityPixelmon pokemon) {
        return pokemon.getPokemonName().contains("Mewtwo") || pokemon.getPokemonName().contains("Mew") || pokemon.getPokemonName().contains("HoOh") || pokemon.getPokemonName().contains("Ho-Oh") || pokemon.getPokemonName().contains("Lugia") ||
